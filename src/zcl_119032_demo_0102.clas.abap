CLASS zcl_119032_demo_0102 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_119032_DEMO_0102 IMPLEMENTATION.
  ...
  DATA d1 TYPE d. "Datum (Bsp.: '20210212')
  DATA t1 TYPE t. "Zeit (Bsp.: '123114')
  DATA p1 TYPE p LENGTH 16 DECIMALS 2. "gepackte Zahl (Bsp.: '734.23')
  DATA b1 TYPE c LENGTH 1. "Pseudo-boolscher Wahrheitswert (Bsp.: 'X' --> wahr)
  ...
  DATA(flight_date) = '20210212'. "...Inlinedeklaration
